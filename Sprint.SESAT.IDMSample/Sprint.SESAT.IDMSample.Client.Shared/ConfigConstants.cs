...
namespace Sprint.SESAT.IDMSample.Client.Shared
{
    public static class ConfigConstants
    {
        ...
        public static string LogoutUrl = "https://login.windows.net/SprintSample.onmicrosoft.com/oauth2/logout?post_logout_redirect_uri=https://sprintsample.azurewebsites.net/Logout";
